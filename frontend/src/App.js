      ...
      <main className="container my-5">
        {selectedPaper ? (
          <div className="selected-paper-details">
            ...
            <p><strong>Problem Definition:</strong> {selectedPaper.problemContent}</p>
            <p><strong>Solution Proposed:</strong> {selectedPaper.solutionContent}</p>
            <p><strong>Methodology Discussed:</strong> {selectedPaper.methodologyContent}</p>
          </div>
        ) : (
          <>
